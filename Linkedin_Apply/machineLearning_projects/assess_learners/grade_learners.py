...
learning_test_cases = [  		  	   		 	   			  		 			     			  	 
    ...
    LearningTestCase(
    description="Test Case 09: Deterministic Tree with New Data",
    group="DTLearner",
    datafile="Istanbul.csv",
    seed=1482100001,
    outputs=None,
    ...
    LearningTestCase(
        description="Test Case 10: Random Tree with New Data",
        group="RTLearner",
        datafile="Istanbul.csv",
        seed=1482100002,
        outputs=dict(
            insample_corr_min=0.85,
            outsample_corr_min=0.18,
            insample_corr_max=0.92,
        ),
    ),
    LearningTestCase(
        description="Test Case 11: Bagging with New Data",
        group="BagLearner",
        datafile="Istanbul.csv",
        seed=1482100003,
        outputs=None,
    ...
    LearningTestCase(
        description="Test Case 12: Deterministic Tree, Different Seed",
        group="DTLearner",
        datafile="Istanbul.csv",
        seed=1482100004,
        outputs=dict(
    ...
    LearningTestCase(
        description="Test Case 13: Random Tree, Different Seed",
        group="RTLearner",
        datafile="Istanbul.csv",
        seed=1482100005,
        outputs=dict(
    ...
    LearningTestCase(
        description="Test Case 14: Bagging, Different Seed",
        group="BagLearner",
        datafile="Istanbul.csv",
        seed=1482100006,
        outputs=None,
    ...
    LearningTestCase(
        description="Test Case 15: Deterministic Tree with New Data, Different Seed",
        group="DTLearner",
        datafile="Istanbul.csv",
        seed=1482100007,
        outputs=dict(
            insample_corr_min=0.90,
            outsample_corr_min=0.20,
            insample_corr_max=0.95,
        ),
    ),
    LearningTestCase(
        description="Test Case 16: Random Tree with New Data, Different Seed",
        group="RTLearner",
        datafile="Istanbul.csv",
        seed=1482100008,
        outputs=dict(
    ...
    LearningTestCase(
        description="Test Case 17: Bagging with New Data, Different Seed",
        group="BagLearner",
        datafile="Istanbul.csv",
        seed=1482100009,
        outputs=None,
    ...
    LearningTestCase(
        description="Test Case 18: Comprehensive Test with Istanbul Data",
        group="DTLearner",
        datafile="Istanbul.csv",
        seed=1482100010,
        outputs=dict(
